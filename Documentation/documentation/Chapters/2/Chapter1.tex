...
\label{Part2Chapter1} % Change X to a consecutive number; for referencing this chapter elsewhere, use \ref{ChapterX}

\lhead{Part \ref{Part2} \nameref{Part2} Chapter \ref{Part2Chapter1}. \emph{\nameref{Part2Chapter1}}} % Change X to a consecutive number;
